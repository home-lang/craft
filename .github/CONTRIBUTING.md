...
```bash
git clone https://github.com/craft-native/craft.git
cd craft
```
...
- **Questions**: Open a [Discussion](https://github.com/craft-native/craft/discussions)
- **Bugs**: Open an [Issue](https://github.com/craft-native/craft/issues)
