...
pub const OAuthConfig = struct {
    ...
    pub fn init(provider: OAuthProvider, client_id: []const u8) OAuthConfig {
        var config: OAuthConfig = .{
            ...
            .client_id = @splat(0),
            .client_id_len = 0,
            .client_secret = @splat(0),
            .client_secret_len = 0,
            .redirect_uri = @splat(0),
            .redirect_uri_len = 0,
            .scope = Scope.full(),
            .use_pkce = provider.supportsPKCE(),
            .custom_auth_endpoint = @splat(0),
            .custom_auth_len = 0,
            .custom_token_endpoint = @splat(0),
            .custom_token_len = 0,
        };
...
pub const PKCEParams = struct {
    ...
    pub fn init() PKCEParams {
        return .{
            .code_verifier = @splat(0),
            .verifier_len = 0,
            .code_challenge = @splat(0),
            .challenge_len = 0,
            .method = .s256,
        };
    }
...
pub const OAuthTokens = struct {
    ...
    pub fn init() OAuthTokens {
        return .{
            .access_token = @splat(0),
            .access_token_len = 0,
            .refresh_token = @splat(0),
            .refresh_token_len = 0,
            .id_token = @splat(0),
            .id_token_len = 0,
            .token_type = .bearer,
