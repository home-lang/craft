...
pub const IntentParameter = struct {
    ...
    /// Description
    description_buffer: [256]u8 = @splat(0),
    ...
    default_buffer: [256]u8 = @splat(0),
    default_len: usize = 0,

    /// Placeholder text
    placeholder_buffer: [128]u8 = @splat(0),
    ...
    options: [8][64]u8 = @splat(@splat(0)),
    option_lens: [8]usize = @splat(0),
...
pub const AppIntent = struct {
    ...
    image_name_buffer: [64]u8 = @splat(0),
    image_name_len: usize = 0,

    /// Shortcut phrase suggestions (max 4)
    suggested_phrases: [4][128]u8 = @splat(@splat(0)),
    suggested_phrase_lens: [4]usize = @splat(0),
...
pub const AppShortcut = struct {
    ...
    short_title_buffer: [64]u8 = @splat(0),
    ...
    parameter_values: [8][256]u8 = @splat(@splat(0)),
    parameter_value_lens: [8]usize = @splat(0),
    parameter_keys: [8][64]u8 = @splat(@splat(0)),
    parameter_key_lens: [8]usize = @splat(0),
    parameter_count: usize = 0,
...
pub const FocusFilter = struct {
    ...
    focus_mode_buffer: [64]u8 = @splat(0),
    focus_mode_len: usize = 0,

    /// Configuration parameters
    config_keys: [8][64]u8 = @splat(@splat(0)),
    config_key_lens: [8]usize = @splat(0),
    config_values: [8][256]u8 = @splat(@splat(0)),
    config_value_lens: [8]usize = @splat(0),
...
pub const IntentResult = struct {
    ...
    value_buffer: [1024]u8 = @splat(0),
    value_len: usize = 0,

    /// Error message if failed
    error_buffer: [256]u8 = @splat(0),
    error_len: usize = 0,

    /// Dialog to show user
    dialog_buffer: [512]u8 = @splat(0),
    dialog_len: usize = 0,
