...
```typescript
import { getMemoryUsage } from 'craft-native'
...
```typescript
import { debounce } from 'craft-native/utils'
...
import { show } from 'craft-native' // Good
import * as craft from 'craft-native' // Bad - imports everything
```
...
import { benchmark } from 'craft-native/perf'
...
```typescript
import { profiler } from 'craft-native/perf'
...
```typescript
import { bench } from 'craft-native/perf'
