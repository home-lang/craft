...
```vue
<script setup lang="ts">
import { useTray } from 'craft-native/vue'
...
```vue
<script setup lang="ts">
import { useNotification } from 'craft-native/vue'
...
<script setup lang="ts">
import { ref } from 'vue'
import { useShortcut } from 'craft-native/vue'
...
```vue
<script setup lang="ts">
import { useTheme } from 'craft-native/vue'
...
```vue
<script setup lang="ts">
import { useMobile } from 'craft-native/vue'
