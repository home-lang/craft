...
```typescript
import { StyleSheet } from 'ts-craft'
...
**Craft:**
```typescript
import { biometrics } from 'ts-craft'
...
**Craft:**
```typescript
import { camera, permissions } from 'ts-craft'
...
// After
import { secureStorage, haptics, biometrics } from 'ts-craft'
```
