...
const targets: BuildTarget[] = [
  ...
  // TypeScript SDK
  { name: 'craft-native SDK (ESM)', path: 'packages/typescript/dist/index.js', platform: 'web' },
  { name: 'craft-native SDK (CJS)', path: 'packages/typescript/dist/index.cjs', platform: 'web' },
  { name: 'craft-native SDK types', path: 'packages/typescript/dist/index.d.ts', platform: 'web' },
  { name: 'craft-native SDK types (CJS)', path: 'packages/typescript/dist/index.d.cts', platform: 'web' },
